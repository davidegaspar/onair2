...
<html class="no-js" lang="en">
    <head>
        ...
        <meta name="description" content="FANTAS FM">
	...
	<nav class="qt-menubar nav-wrapper qt-content-primary " >
	    ...
	    <ul class="qt-desktopmenu hide-on-xl-and-down">
	        <ul class="qt-desktopmenu hide-on-xl-and-down"><li class="qt-logo-link"><a href="/" class="brand-logo qt-logo-text"><img src="imagestemplate/fantasfm_logo_3_xmas.jpg" alt="Home"></a></li>
	    ...
	    <ul class="qt-desktopmenu hide-on-xl-only ">
	        ...
	        <li><a href="#!" class="brand-logo qt-logo-text"></a></li>
	    </ul>
	</nav>
